...
(function () {
   ...
   b2Mat22.prototype.Set = function (angle) {
      if (angle === undefined) angle = 0;
      var c = bonkMath.fixedTrig.cos(angle);
      var s = bonkMath.fixedTrig.sin(angle);
      this.col1.x = c;
      this.col2.x = (-s);
      this.col1.y = s;
      this.col2.y = c;
   ...
   b2Mat22.prototype.GetAngle = function () {
      return bonkMath.fixedTrig.atan2(this.col1.y, this.col1.x);
   }
   ...
   b2Transform.prototype.GetAngle = function () {
      return bonkMath.fixedTrig.atan2(this.R.col1.y, this.R.col1.x);
   }
...
(function () {
   ...
   b2Body.prototype.connectEdges = function (s1, s2, angle1) {
      ...
      var angle2 = bonkMath.fixedTrig.atan2(s2.GetDirectionVector().y, s2.GetDirectionVector().x);
      var coreOffset = bonkMath.fixedTrig.tan((angle2 - angle1) * 0.5);
